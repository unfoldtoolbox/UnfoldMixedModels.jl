...
Unfold.design_to_modeltype(f::AbstractTerm, t::Unfold.BasisFunction) =
    isa_lmm_formula(f) ? UnfoldLinearMixedModelContinuousTime :
    UnfoldLinearModelContinuousTime
Unfold.design_to_modeltype(f::AbstractTerm, t::AbstractVector) =
    isa_lmm_formula(f) ? UnfoldLinearMixedModel : UnfoldLinearModel
